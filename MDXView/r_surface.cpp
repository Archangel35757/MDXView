...
//
void R_MDXView_BeginEntityAdd()
{
	tr.refdef.num_entities = 0;
	tr.refdef.numDrawSurfs = 0;
}

void R_MDXView_AddEntity(ModelHandle_t hModel,			int iFrame_Primary, int iOldFrame_Primary, 
...
// entry point from MDXView draw function to setup all surfaces ready for actual render call later...
//
