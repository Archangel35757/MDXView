...
static void ModelContainer_CallBack_AddToDrawList(ModelContainer_t* pContainer, void *pvData)
{
	glPushMatrix();
	{
		...
		if (bProceed)
		{
//			R_ModView_BeginEntityAdd();	// ################## //Archangel
...
//			pContainer->iRenderedBoneWeightsThisSurface = 0;
			...
			{
//				RE_GenerateDrawSurfs();	//Archangel
//				RE_RenderDrawSurfs();	//Archangel
			}
...
//		TextData.iTextY += TEXT_DEPTH;
		...
		{				
//			GetWeightColour(i,r,g,b);	//Archangel
...
//		GL_Enter3D( AppVars.dFOV, iWindowWidth, iWindowHeight, AppVars.bWireFrame, false);	//Archangel
